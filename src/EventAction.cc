...
void EventAction::BeginOfEventAction(const G4Event* evt)
{
 ...
 fEnergyDeposit1  =  fEnergyDeposit2 = fEnergyDepositL1  =  fEnergyDepositL2 = fEnergyDepositSc1 = fEnergyDepositSc2 = fEnergyDepositAir = fEnergyDepositAl = fEnergySecondary1 = fEnergySecondary2 = fEnergyTertiary1 = fEnergyTertiary2 = 0.;
 ...
 fPointPix1ent = fPointPix1entReal = fPointPix1mid = fPointPix1ex = fPointDet1ent = fPointDet1entReal = fPointDet1mid = fPointDet1ex = fPointDet2ent = fPointDet2entReal = fPointDet2mid = fPointDet2ex = fPointPix2ent = fPointPix2entReal = fPointPix2mid = fPointPix2ex = fPoint20Scint = G4ThreeVector(0, 0, 0);
...
void EventAction::EndOfEventAction(const G4Event* evt)
{
 ...
 analysisManager->FillH2(1, fPoint20Scint.x(), fPoint20Scint.y());
