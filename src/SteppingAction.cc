...
void SteppingAction::UserSteppingAction(const G4Step* step)
{
 //get volume of the current step
  ...
  G4double ekinAlent, ekinAlex, ekinScint1ent, ekinScint1ex, ekinScint2ent, ekinScint2ex, ekinPix1ent, ekinPix1ex, ekinPix2ent, ekinPix2ex, ekinDet1ent, ekinDet1ex, ekinDet2ent, ekinDet2ex;
